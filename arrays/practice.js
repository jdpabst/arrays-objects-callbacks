...
function finder(arr){
  ...
  return false;
//   Make sure that you don't include the else statement in the for loop otherwise it won't run properly. Include the "else" outside of the for loop
// 
}
...
var user2 = {
  ...
  password: "catzrule", 
  username: "Booboo"};
var user3 = {name: "Wynter", 
  email: "wynter@email.com", 
  password: "wtrislyfe", 
  username: "Squinter"}
